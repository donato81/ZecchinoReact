...
- Note operative: non introdurre updated_at; il file deve motivare la scelta append-heavy gia fissata dal design.
...
- G-019-6 | Verifica: la migrazione P55 documenta correttamente tabella, indici, metadata JSONB e assenza di updated_at. | Comando: verifica manuale su docs/6-sql/P55-notifiche.sql | Stato iniziale: OPEN
