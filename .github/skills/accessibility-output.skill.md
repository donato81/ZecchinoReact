...
description: Standard di output per tutti gli agenti del framework. Garantisce che
  ogni risposta sia navigabile da tastiera e compatibile con screen reader NVDA su
  Windows 11. Richiamabile da tutti gli agenti del framework.
---
