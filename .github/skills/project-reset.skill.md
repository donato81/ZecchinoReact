...
spark: true
description: 'Skill per resettare il profilo progetto (`.github/project-profile.md`)
  in modo sicuro e guidato. Effettua backup, applica l''azione scelta (elimina file
  o imposta `initialized: false`) e fornisce istruzioni per rilanciare il setup tramite
  `#project-setup`.'
name: project-reset
---
