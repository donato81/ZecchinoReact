...
spark: true
description: Bootstrap iniziale della documentazione di progetto con struttura minima
  e file guida.
...
Segnaposto sostituiti: `{{NOME_PROGETTO}}` letto da `project_name`
...
Segnaposto sostituiti: `{{NOME_PROGETTO}}`, `{{LINGUAGGIO_PRIMARIO}}`,
...
3. Se non esiste: creare il file, sostituire i segnaposto, salvare.
...
| Segnaposto | Sorgente | Template che lo usano |
|-------------|----------|-----------------------|
