...
description: 'Guardia standardizzata per bloccare modifiche accidentali ai componenti
  protetti del framework quando framework_edit_mode e false. Importabile dagli agenti
  che possono toccare file in .github/.
