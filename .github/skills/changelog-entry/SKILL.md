...
description: Regole per generare una voce CHANGELOG da un git diff. Determina sezione,
  formato e contenuto della voce da inserire in [Unreleased] di CHANGELOG.md. Richiamabile
  da Agent-Git durante OP-2 (Commit).
---
