...
description: 'Procedura obbligatoria di guardia per qualsiasi operazione che elimina
  file o directory. Si applica a tutti gli agenti in tutti i contesti, inclusi merge
  con conflitti.
