...
spark: true
name: error-recovery
description: Procedura standardizzata di retry e escalata quando un subagente fallisce
  l'esecuzione di un task. Utilizzata dagli Orchestratori per gestire errori in modo
