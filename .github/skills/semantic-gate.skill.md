...
spark: true
name: semantic-gate
description: Criteri minimi osservabili da verificare prima di avanzare tra le fasi
  Analyze, Design e Plan nel ciclo E2E. Ogni criterio richiede la presenza di sezioni
  con nomi esatti nel documento prodotto dalla fase precedente. Richiamabile da Agent-Orchestrator
  in Fase 1, 2 e 3.
---
