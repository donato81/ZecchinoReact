...
spark: true
name: personality
description: 'Skill per la gestione della postura operativa e dello stile relazionale
  degli agenti. Definisce i profili canonici, la logica di cascata per la risoluzione
  del valore e le regole comportamentali per ciascun profilo. Non governa densita
  informativa o scaffolding: quelli appartengono a verbosity.skill.md.
