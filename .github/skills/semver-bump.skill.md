...
spark: true
name: semver-bump
description: Logica SemVer per determinare il tipo di bump di versione. Richiamabile
  da Agent-Release e Agent-FrameworkDocs per proporre la versione corretta prima di
  ogni release.
---
