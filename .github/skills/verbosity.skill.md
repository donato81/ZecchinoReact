...
spark: true
name: verbosity
description: 'Skill per la gestione della verbosita comunicativa degli agenti. Definisce
  i tre profili canonici, la logica di cascata per la risoluzione del valore e le
  regole comportamentali per ciascun livello. Non sovrascrive policy git, guardie
  framework o regole di accessibilita.
