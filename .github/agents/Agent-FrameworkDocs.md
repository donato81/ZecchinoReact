...
- GPT-5 mini (copilot)
description: 'Agente esclusivo per la manutenzione del Framework Copilot. Aggiorna
  FRAMEWORK_CHANGELOG.md, AGENTS.md, copilot-instructions.md, README.md di .github/
  e README.md delle sottocartelle agents/ e prompts/. Non tocca mai file fuori da
  .github/.
