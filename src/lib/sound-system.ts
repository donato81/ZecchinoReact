...
class SoundSystem {
  ...
  private createEnvelope(
    ...
    const safeDuration = Math.max(
      safeAttack + safeDecay + safeRelease + 0.01,
      duration,
    );
    ...
    switch (soundType) {
      ...
      case 'unlock':
        this.playSequence([
          ...
          { freq: 1046.5, duration: 0.15, type: 'sine', delay: 60 },
        ]);
        break;
      ...
      case 'expense':
        this.playSequence([{ freq: 440, duration: 0.15, type: 'triangle' }]);
        break;
      ...
      case 'milestone':
        this.playSequence([
          ...
          { freq: 1046.5, duration: 0.2, type: 'sine', delay: 80 },
        ]);
        break;
      ...
      case 'filter-toggle':
        this.playTone(550, 0.06, 'triangle', {
          attack: 0.005,
          decay: 0.02,
          sustain: 0.5,
          release: 0.035,
      ...
      case 'export':
        this.playSequence([
          ...
          { freq: 1046.5, duration: 0.12, type: 'sine', delay: 70 },
        ]);
        break;
      ...
      case 'goal-completed':
        this.playSequence([
          ...
          { freq: 659.25, duration: 0.1, type: 'sine', delay: 80 },
          { freq: 783.99, duration: 0.1, type: 'sine', delay: 80 },
          { freq: 1046.5, duration: 0.15, type: 'sine', delay: 80 },
      ...
      case 'private-unlock':
        this.playSequence([
          ...
          { freq: 1046.5, duration: 0.14, type: 'sine', delay: 60 },
        ]);
        break;
      ...
      case 'confirm':
        this.playSequence([
          { freq: 659.25, duration: 0.08, type: 'sine' },
          { freq: 783.99, duration: 0.08, type: 'sine', delay: 60 },
          { freq: 1046.5, duration: 0.1, type: 'sine', delay: 60 },
        ]);
        break;
      ...
      case 'select-option':
        this.playTone(659.25, 0.05, 'sine', {
          attack: 0.002,
          decay: 0.015,
          sustain: 0.4,
          release: 0.033,
      ...
      case 'import-success':
        this.playSequence([
          ...
          { freq: 1046.5, duration: 0.13, type: 'sine', delay: 70 },
        ]);
        break;
      ...
      case 'test-sound':
        this.playSequence([
          ...
          { freq: 1046.5, duration: 0.12, type: 'sine', delay: 75 },
        ]);
        break;
