...
export function announceSavingsGoalCreated(name: string, target: number): Announcement {
  return build(t('obiettivo_creato', { name, amount: formatCurrencyVocal(target) }))
}
