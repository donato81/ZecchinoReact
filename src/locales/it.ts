...
export const it = {
  ...
  'errors.ricorrenze.deactivateFailed': 'Impossibile disattivare la ricorrenza.',
  ...
  'errors.tag.addToTransactionFailed': 'Impossibile associare il tag alla transazione.',
  'errors.tag.removeFromTransactionFailed': 'Impossibile rimuovere il tag dalla transazione.',
  ...
  'errors.notifiche.markReadFailed': 'Impossibile segnare la notifica come letta.',
  'errors.notifiche.markAllReadFailed': 'Impossibile segnare le notifiche come lette.',
  'errors.notifiche.removeFailed': 'Impossibile eliminare la notifica.',
  'errors.notifiche.cleanupFailed': 'Impossibile eseguire la pulizia delle notifiche.',
  ...
  'notifiche.budget.soglia': 'Il budget {name} ha raggiunto il {percent} percento.',
  'notifiche.budget.superato': 'Il budget {name} è stato superato. Speso {spent} su {target}.',
  ...
  'errors.allegati.sizeLimitExceeded': 'Il file supera il limite massimo di 10 MB.',
  'errors.allegati.mimeNotAllowed': 'Tipo di file non consentito.',
  'errors.allegati.mimeExtensionMismatch': 'Estensione e tipo file non sono coerenti.',
  ...
  'allegati.upload.signedUrlFailed': 'Impossibile generare il link temporaneo dell\'allegato.',
} as const
